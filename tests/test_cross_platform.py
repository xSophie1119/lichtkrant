...
checks={}
checks['version_430']=tuple(map(int,server.APP_VERSION.split('.'))) >= (4,3,0)
...
checks['readme_multiplatform']='MultiPlatform v' in readme and './START_P2000.sh' in readme and 'START_P2000.bat' in readme
