...
## Nieuw in v4.4.18 — Windows-herstel, betrouwbare omroep en platformmappen
...
- Tankautospuiten worden in de omroep expliciet als **T S** uitgesproken; roepnummers zelf blijven uit de gesproken tekst. De beheerpreview gebruikt dezelfde regel.
...
```text
P2000_Monitor_v4.4.18_Windows_Linux.zip
```
