# P2000 Monitor — Linux v4.4.18

> **Deze map is de zelfstandige Linux-release.** Gebruik alleen de starters in deze map; bestanden voor het andere platform staan bewust in de andere hoofdmap.


Configureerbare P2000-lichtkrant voor **Linux**. Deze map is volledig zelfstandig en bevat alleen de Linux-starters/installers.

> Informatieve monitor. Niet bedoeld als officieel of primair alarmeringsmiddel.

## Nieuw in v4.4.18 — platformmap en omroep

- De Linux-release staat nu volledig los in de map `Linux/`; Windows-starters en PowerShell-bestanden zitten er niet meer tussen.
...
- De gecombineerde distributie kan door de updater per platform worden herkend; op Linux wordt automatisch de `Linux/` map gekozen.
- De remote test-/displayfallback uit v4.4.17 blijft actief voor andere browsers, vensters en apparaten die dezelfde backend gebruiken.
